...
def train(dataloader,model,optimizer,profile_memory):
    global_step = 0
...
if __name__ == "__main__":
    ...
    galore_optimizer = GaLoREOptimizer(trainable_params, lr=0.001)
    train(dataloader,model,galore_optimizer,profile_memory)
